...
C
       ...
       n_cosines(3,1:3)=(/T0,T0,0.0D0/)
       n_cosines(4,1:3)=(/T0,-T0,0.0D0/)
       n_cosines(5,1:3)=(/0.0D0,0.0D0,1/)
       ...
       n_weight(1:2)=(/0.0265214244093,0.0265214244093/)
       n_weight(3:4)=(/0.0199301476312,0.0199301476312/)
       n_weight(5)=0.0265214244093
       DO I=6,9
...
C ---  Get state variables from STATEV(vector)
       ...
       epsel_v(1:4)=STATEV(43:46)
       epsE_v(1:4)  = STATEV(47:50)
       epsin_v(1:4) = STATEV(51:54)
       energy(1:5)=STATEV(55:59)
...
C
       ...
       STATEV(43:46)=epsel_v(1:4)
       STATEV(47:50)=epsE_v(1:4)
       STATEV(51:54)=epsin_v(1:4)
       STATEV(55:59)=energy(1:5)
C
...
C
       ...
       DO I = 1 , 2
         ...
         ENDDO
       ENDDO
       DDSDDE(NTENS ,   1)=matDz_2(NTENS , 1);
       DDSDDE(NTENS ,   2)=matDz_2(NTENS , 2);
       DDSDDE(1,    NTENS)=matDz_2(1,  NTENS);
       DDSDDE(2,    NTENS)=matDz_2(2,  NTENS);
       DDSDDE(NTENS,NTENS)=matDz_2(2,  NTENS); 
C
C
       RETURN
       END
